            ...
            <div class="wrap">
                <div class="row mb2">
                    <div class="col-xs-12 center-xs">
                        ...
                        <p class="t3 w100 ff2 uc tcb"><?php echo get_the_date('d M \d\e Y'); ?>, por <?php if($cols = get_field('colaboradores')){ echo implode(", ", array_map(function($a){return '<a class="w600" href="'.get_the_permalink($a).'">'.get_the_title($a).'</a>';}, $cols)); }else{echo 'OKBR';} ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
