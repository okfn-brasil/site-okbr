                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <ul class="lista-horizontal m0">
                                        ...
                                        <li class="mr05 ml05 dropdown"><button type="button" class="rede-social feed"></button>
                                            <ul class="dropdown-child">
                                                <li><a target="_blank" href="https://okbr.escoladedados.org/feed/?post_type=noticia">Noticias</a></li>
                                                <li><a target="_blank" href="https://okbr.escoladedados.org/feed/?post_type=evento">Eventos</a></li>
                                            </ul>
                                        </li>
