...
class ITSEC_Settings_Page_Sidebar_Widget_Sync_Cross_Promo extends ITSEC_Settings_Page_Sidebar_Widget {
	...
	public function render( $form ) {
		...
		echo '<p>' . __( 'Integrated with iThemes Security, so you can release lockouts, authorize IPs, and turn Away Mode on or off right from your Sync dashboard.', 'it-l10n-ithemes-security-pro' ) . '</p>';
