...
class ITSEC_Four_Oh_Four_Validator extends ITSEC_Validator {
	...
	protected function sanitize_settings() {
		...
		$this->sanitize_setting( array( $this, 'sanitize_white_list_entry' ), 'white_list', __( '404 File/Folder Ignore List', 'it-l10n-ithemes-security-pro' ) );
		$this->sanitize_setting( array( $this, 'sanitize_types_entry' ), 'types', __( '404 File/Folder Ignore List', 'it-l10n-ithemes-security-pro' ) );
	}
