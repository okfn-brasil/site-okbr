...
final class ITSEC_Global_Settings_Page extends ITSEC_Module_Settings_Page {
	...
	protected function render_settings( $form ) {
		...
		<table class="form-table itsec-settings-section">
			...
			<tr>
				<th scope="row"><label for="itsec-global-blacklist"><?php _e( 'Ban Repeat Offender', 'it-l10n-ithemes-security-pro' ); ?></label></th>
				<td>
					<?php $form->add_checkbox( 'blacklist' ); ?>
					<label for="itsec-global-blacklist"><?php _e( 'Enable Ban Repeat Offender', 'it-l10n-ithemes-security-pro' ); ?></label>
					<p class="description"><?php _e( 'If this box is checked the IP address of the offending computer will be added to the "Ban Users" list after reaching the number of lockouts listed below.', 'it-l10n-ithemes-security-pro' ); ?></p>
				</td>
			</tr>
			<tr>
				<th scope="row"><label for="itsec-global-blacklist_count"><?php _e( 'Ban Threshold', 'it-l10n-ithemes-security-pro' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="itsec-global-blacklist_period"><?php _e( 'Ban Lookback Period', 'it-l10n-ithemes-security-pro' ); ?></label></th>
				<td>
					...
					<p class="description"><?php _e( 'How many days should a lockout be remembered to meet the ban threshold above.', 'it-l10n-ithemes-security-pro' ); ?></p>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<p class="description"><?php _e( 'The length of time a host or user will be banned from this site after hitting the limit of bad logins. The default setting of 15 minutes is recommended as increasing it could prevent attacking IP addresses from being banned.', 'it-l10n-ithemes-security-pro' ); ?></p>
				</td>
			</tr>
			<tr>
				<th scope="row"><label for="itsec-global-lockout_white_list"><?php _e( 'Authorized Hosts List', 'it-l10n-ithemes-security-pro' ); ?></label></th>
				<td>
					<?php $form->add_textarea( 'lockout_white_list' ); ?>
					<p><?php $form->add_button( 'add-to-whitelist', array( 'value' => __( 'Add my current IP to the Authorized Hosts List', 'it-l10n-ithemes-security-pro' ), 'class' => 'button-primary' ) ); ?></p>
					<p class="description"><?php _e( 'Use the guidelines below to enter hosts that will not be locked out from your site. This will keep you from locking yourself out of any features if you should trigger a lockout. Please note this does not override away mode.', 'it-l10n-ithemes-security-pro' ); ?></p>
					<ul>
						<li>
							<?php _e( 'You can add authorized users by individual IP address or IP address range using wildcards or CIDR notation.', 'it-l10n-ithemes-security-pro' ); ?>
							<ul>
			...
			<tr>
				<th scope="row">
					<label for="itsec-global-manage_group">
						<?php esc_html_e( 'Manage iThemes Security', 'it-l10n-ithemes-security-pro' ) ?>
					</label>
				</th>
				<td>
					<p class="description">
						<?php esc_html_e( 'Select the group of users that can manage iThemes Security. If no groups are selected, all administrator users will have access.', 'it-l10n-ithemes-security-pro' ); ?>
					</p>
